...
def run_eval(num_matches):
    ...
    winner_dict = [{'0':'pass_bot','1':'mcts_bot','null':'draw'},
                   {'0':'mcts_bot','1':'pass_bot','null':'draw'}]
    ...
    for i in xrange(1, num_matches+1):
        ...
        if (i & 1):
            subprocess.call("./passbot_run_wrapper.sh")
        else:
            subprocess.call("./passbot_run_wrapper_flipped.sh")
